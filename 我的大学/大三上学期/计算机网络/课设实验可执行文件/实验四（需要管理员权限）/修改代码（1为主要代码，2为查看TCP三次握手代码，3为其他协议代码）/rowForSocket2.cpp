...
void DecodeIPPacket(char *pData) {
    ...
    switch (pIphdr->Protocol) {
        case IPPROTO_TCP :  // 6
            ...
            switch (ntohs(pTcphdr->sourcePort)) {
                case 80:
                    printf_s("Request received from 80 port. Details: %s\n", pData + sizeof(TCP_HDR));
                    break;
                case 21:
                    printf_s("Request received from 21 port. Details: %s\n", pData + sizeof(TCP_HDR));
                    break;
                case 8080:
                    printf_s("Request received 8080 port. Details: %s\n", pData + sizeof(TCP_HDR));
                    break;
            }
            break;
    }
